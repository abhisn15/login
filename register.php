...
<style>
    body {
        ...
        align-items: center;
        height: 100vh;
        /* Mengisi tinggi viewport secara penuh */
    }
...
<body>
    <form class="form_main" action="process_form.php" method="post">
        <p class="heading">Register</p>
        <div class="inputContainer">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 260" fill="#2e2e2e" height="16" width="16" id="user" class='inputIcon'>
            ...
            <input placeholder="Username" name="username" id="username" class="inputField" type="text" required>
        </div>
        <div class="inputContainer">
            <svg viewBox="0 0 16 16" fill="#2e2e2e" height="16" width="16" xmlns="http://www.w3.org/2000/svg" class="inputIcon">
            ...
            <input placeholder="Email" name="email" id="email" class="inputField" type="text" required>
        </div>
        <div class="inputContainer">
            <svg viewBox="0 0 16 16" fill="#2e2e2e" height="16" width="16" xmlns="http://www.w3.org/2000/svg" class="inputIcon">
            ...
            <input placeholder="Password" name="password" id="password" class="inputField" type="password" required>
        </div>
        <img class='captcha' src="captcha.php" alt="Captcha Image">
        <div class="inputContainer">
            <input class='inputField' type="text" name="captcha_input" placeholder="Enter Captcha" required>
        </div>
